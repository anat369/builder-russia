        ...
        <!-- Default box -->
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Обновить описание услуги</h3>
                ...
                <div class="box-body">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputTitle" placeholder="" value="{{$service->title}}" name="title">
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="description" id="exampleInputDescription" cols="20" rows="10" class="form-control" >{{$service->description}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="content" id="exampleInputContent" cols="30" rows="10" class="form-control" >{{$service->content}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 panel panel-default" style="border-color: red;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputMetaKeywords" placeholder="Не более 80 символов"
                                   name="meta_keyword" value="{{$service->meta_keyword}}">
                        </div>
                        <div class="form-group">
